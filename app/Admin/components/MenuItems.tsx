...
//     try {
//       const response = await fetch(`http://${endpoints.next_ip_port}/api/menu`);
...
//   //   const handleMenuCategoryChange = (value: string) => {
...
//         ? `http://localhost/api/menu/${editingMenuItem.foodId}`
...
//   const handleEditMenuItem = (item: typeof menuFormData) => {
//     setEditingMenuItem(item);
//     setMenuFormData(item);
//     setIsMenuModalOpen(true);
//   };

//   const handleDeleteMenuItem = async (foodId: string) => {
//     try {
//       const response = await fetch(`http://localhost/api/menu/${foodId}`, {
//         method: "DELETE",
//       });
...
//                   variant="ghost"
//                   size="sm"
//                   onClick={() => handleDeleteMenuItem(item.foodId)}
//                 >
