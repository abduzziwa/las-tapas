    ...
    <AuthGuard>
      <main className="flex flex-col min-h-screen bg-gray-50">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg,#0a3d62,#1a5276)' }}
        >
          <div className="absolute inset-0 opacity-25"
            style={{ background: 'radial-gradient(circle at 70% 40%,#2980b9,transparent 60%)' }} />
          <h1 className="relative text-white text-3xl font-bold drop-shadow-sm">Drinks</h1>
        </div>
