  ...
  return (
    <main>
      ...
      <div className="flex flex-col w-full items-center p-[24px] gap-[10px]">
        ...
        <Link href="/menu/foods" className="flex items-end w-full h-[155px] rounded-[20px] py-[10px] px-[16px] drop-shadow-lg bg-[url('../public/food.png')] bg-cover bg-center">
        ...
        <div className="flex flex-row w-full gap-[10px]">
          ...
          <Link href="/menu/drinks" className="flex items-end w-full w-50% h-[155px] rounded-[20px] py-[10px] px-[16px] drop-shadow-lg bg-[url('../public/drinks.png')] bg-cover bg-center">
            <p className="text-white text-[28px] font-bold drop-shadow-lg leading-tight">
              Drinks
            </p>
          </Link>

          <Link href="/menu/desserts" className="flex items-end w-full h-[155px] rounded-[20px] py-[10px] px-[16px] drop-shadow-lg bg-[url('../public/desserts.png')] bg-cover bg-center">
            <p className=" text-white text-[28px] font-bold drop-shadow-lg leading-tight">
              Desserts
            </p>
          </Link>
